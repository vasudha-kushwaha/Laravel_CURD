    ...
    <nav>
      <div class="nav-wrapper  green">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li><a href="{{ route('todo.about') }}">About</a></li>
          <li><a href="{{ route('todo.blogs') }}">Blogs</a></li>
          <li><a href="{{ route('todo.authors') }}">Authors</a></li>
          <li><a href="{{ route('todo.adminlogin') }}">Admin Login</a></li>
          <li><a href="{{ route('todo.curd') }}">Curd Operation</a></li>
        </ul>
      </div>
    </nav>
  </div>
